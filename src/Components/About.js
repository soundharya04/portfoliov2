      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-lg-6 col-md-12 about-title">
            ...
            <div className="paragraph py-2 w-75">
              <p className="para">
              ...
              <p className="para">
                Each site I develope is build to be both user and search engine
                friendly using the latest development principles and
                technologies. To find out more about what I can do check out
                below
              </p>
